...
* Hadley Wickham's _R Packages_ is an excellent, readable resource on package development and is available as a [free book on the web](http://r-pkgs.had.co.nz/).
